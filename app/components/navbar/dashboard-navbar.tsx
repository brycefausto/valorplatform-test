...
export default function DashboardNavbar() {
  ...
  return (
    <header className="sticky top-0 px-4 gap-2 inset-x-0 flex flex-wrap items-center md:justify-start md:flex-nowrap z-[48] w-full bg-white border-b text-sm py-2.5  dark:bg-neutral-800 dark:border-neutral-700">
      <SidebarTrigger className="-ml-1" />
      <Separator orientation="vertical" className="shrink-0 bg-border w-[1px] mr-2 h-4" />
      <nav className="mx-auto w-full px-4 sm:px-6 lg:px-8 flex basis-full items-center">
        <div className="me-5">
          {/* Logo */}
          ...
          <div className="flex flex-row items-center justify-end gap-1">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Avatar>
                  <AvatarImage src="/images/profile_placeholder.jpg" alt="Profile" />
                  <AvatarFallback>
